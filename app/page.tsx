      ...
      <section style={{
        ...
        <div className="fade-in" style={{ maxWidth: '640px' }}>
          ...
          <p style={{
            ...
            Browse hilarious images, read the funniest captions, and vote for your favorites. 
            The best humor rises to the top.
          </p>
          ...
          <div style={{
            ...
            {[
              { icon: '🖼️', label: 'Browse images' },
              { icon: '👆', label: 'Vote on captions' },
              { icon: '🏆', label: 'See top rated' },
            ].map((item, i) => (
